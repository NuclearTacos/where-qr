// Inline SVG icons (Lucide-style, 24px grid, stroke-based). Kept tiny and
// dependency-free. All return trusted markup.
import { raw } from './html.js';

const svg = (paths, extra = '') =>
  raw(`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" ${extra}>${paths}</svg>`);

export const icons = {
  qr: svg('<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3h-3zM20 14v3M17 20h3M14 20h.01"/>'),
  ...
  flash: svg('<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>'),
  flashOff: svg('<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/><line x1="2" y1="2" x2="22" y2="22"/>'),
  ...
  broom: svg('<path d="M19.36 2.72l1.42 1.42-5.72 5.71c1.07 1.54 1.22 3.39.32 4.59L9.06 8.12c1.2-.9 3.05-.75 4.59.32l5.71-5.72zM5.93 9.26l8.81 8.81c-2.4 1.7-5.98 1.4-8.6-1.22-2.62-2.62-2.92-6.2-1.22-8.6z"/>'),
};
